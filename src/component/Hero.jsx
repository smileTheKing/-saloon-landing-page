...
const Hero = () => {
  return (
    <div className="mx-auto  text-white  relative">
      ...
      <div className="max-w-[1024px] w-full mx-auto flex flex-col lg:h-[100%]  pt-8 lg:pt-0 relative">
        ...
        <div className="w-full lg:absolute -bottom-[155px]  left-0 right-0 h-[240px] bg-white text-black lg:rounded-md place-items-center grid px-4 border-[1.5px] border-[#e14282]/50 ">
