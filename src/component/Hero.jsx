      ...
      <div className="max-w-[1024px] w-full mx-auto flex flex-col lg:h-[450px]  pt-8 lg:pt-12 relative">
        ...
        <div className="w-full lg:absolute -bottom-[190px]  left-0 right-0 h-[240px] bg-white text-black lg:rounded-md place-items-center grid px-4 border-[1.5px] border-[#e14282]/50 ">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4  gap-4">
            ...
            <input type="time" className="border sm:w-56 p-1 border-[#4A4041]/30 text-gray-400 rounded " placeholder="choose time"  />
            <input type="date"className="border sm:w-56 p-1 border-[#4A4041]/30 text-gray-400 rounded"placeholder="choose date" />
          </div>
